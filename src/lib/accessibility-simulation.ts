...
export const SIMULATION_INFO: Record<SimulationType, SimulationInfo> = {
	...
	'low-contrast': {
		...
		description:
			'Difficulty distinguishing between similar colors and tones.',
	...
	'tunnel-vision': {
		name: 'Tunnel Vision',
		description:
			'Loss of peripheral vision, seeing only a small central area.',
	...
	glaucoma: {
		name: 'Glaucoma',
		description:
			'Gradual loss of peripheral vision due to optic nerve damage.',

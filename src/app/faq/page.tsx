			...
			<div className="container mx-auto px-4 py-8 max-w-4xl">
				...
				<div className="text-center mb-12">
					...
					<p className="text-xl text-base-content/80">
						Find answers to common questions about LiveTheme&apos;s
						free website templates and theme editor.
					</p>
				</div>
				...
				<div className="text-center mt-12 bg-base-200 rounded-lg p-8">
					...
					<p className="text-base-content/80 mb-6">
						Browse our collection of free website templates and
						start customizing your perfect design today!
					</p>

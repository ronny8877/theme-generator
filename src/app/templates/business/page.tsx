				...
				dangerouslySetInnerHTML={{
					__html: JSON.stringify({
						...
						mainEntity: {
							...
							itemListElement: businessTemplates.map(
								(template, index) => ({
									'@type': 'ListItem',
									position: index + 1,
									item: {
			...
			<div className="container mx-auto px-4 py-8">
				...
				<div className="mb-12 text-center">
					...
					<p className="text-xl text-base-content/80 max-w-3xl mx-auto">
						Professional website templates designed for modern
						businesses, startups, and entrepreneurs. Create a
						stunning business presence with fully customizable
						designs that you can edit in real-time.
					</p>
				</div>
					...
					<div className="grid md:grid-cols-3 gap-6">
						<div className="text-center">
							...
							<p className="text-sm text-base-content/80">
								Modern, clean designs that establish credibility
						...
						<div className="text-center">
							...
							<p className="text-sm text-base-content/80">
								All templates are fully responsive and look
								great on desktop, tablet, and mobile devices.
							</p>
						</div>
						<div className="text-center">
							<div className="text-3xl mb-3">⚡</div>
							...
							<p className="text-sm text-base-content/80">
								Built with performance in mind for fast loading
								times and better SEO rankings.
							</p>
						</div>
					</div>
				</div>
				...
				<div className="text-center bg-primary/10 rounded-lg p-8">
					...
					<p className="text-base-content/80 mb-6">
						Choose a template above and start customizing your
						business website in real-time. No coding required - just
						point, click, and customize to match your brand.
					</p>

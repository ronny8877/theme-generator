				...
				dangerouslySetInnerHTML={{
					__html: JSON.stringify({
						...
						mainEntity: {
							...
							itemListElement: blogTemplates.map(
								(template, index) => ({
									'@type': 'ListItem',
									position: index + 1,
									item: {
			...
			<div className="container mx-auto px-4 py-8">
				...
				<div className="mb-12 text-center">
					...
					<p className="text-xl text-base-content/80 max-w-3xl mx-auto">
						Professional blog templates designed for content
						creators, writers, and bloggers. Customize colors,
						fonts, and layouts in real-time to create the perfect
				...
				<div className="text-center bg-base-200 rounded-lg p-8">
					...
					<p className="text-base-content/80 mb-6">
						Choose a template above and start customizing your blog
						theme in real-time. No account required - just click,
						edit, and export when you&apos;re ready.
					</p>

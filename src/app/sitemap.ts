...
const routeConfig: Array<{
	...
	{
		path: '/preview/simple-blog-post',
		priority: 0.8,
		changeFrequency: 'monthly',
	},
	{
		path: '/preview/personal-portfolio',
		priority: 0.8,
		changeFrequency: 'monthly',
	},
	{
		path: '/preview/saas-landing',
		priority: 0.8,
		changeFrequency: 'monthly',
	},
	{
		path: '/preview/ecommerce-store',
		priority: 0.8,
		changeFrequency: 'monthly',
	},
	...
	{
		path: '/preview/simple-blog-landing',
		priority: 0.7,
		changeFrequency: 'monthly',
	},
	{
		path: '/preview/techcore-blog',
		priority: 0.7,
		changeFrequency: 'monthly',
	},
	{
		path: '/preview/cooking-recipe-site',
		priority: 0.7,
		changeFrequency: 'monthly',
	},
	{
		path: '/preview/cookbook-landing',
		priority: 0.7,
		changeFrequency: 'monthly',
	},
	...
	{
		path: '/preview/twitter-like-social',
		priority: 0.6,
		changeFrequency: 'monthly',
	},

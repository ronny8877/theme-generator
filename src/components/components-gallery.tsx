					...
					<section className="grid grid-cols-1 @md:grid-cols-2 gap-6 items-center">
						<div>
							...
							<p className="opacity-70 text-sm mt-1">
								A curated walk-through of common UI patterns
								rendered with your active theme. Tweak tokens
								and see everything update live.
							</p>
							...
							<div className="card bg-base-100 border border-base-300">
								<div className="card-body gap-3">
									<p className="text-sm opacity-80">
										Story: we start in a conversation where
										the new theme is reviewed. Typography,
										spacing, and colors come from your
										active theme tokens.
									</p>
									<div className="alert">
										<div>
											...
											<div className="text-sm opacity-70">
												Chat UI and mockups are provided
												by DaisyUI on top of Tailwind.
											</div>
										</div>
									</div>
								</div>
							...
							<div className="card bg-base-100 border border-base-300 @md:col-span-2">
								...
								<div className="card-body">
									...
									<p className="opacity-70 text-sm">
										Clean product card. Try switching theme
								...
								<div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
									{[
										...
										>
											...
											<button
												className={`btn rounded-box ${variant.cls}`}
											>
						...
						<div className="card bg-base-100 border border-base-300">
							<div className="card-body gap-4">
								...
								<div className="toast">
									<div className="alert alert-info">
										<span>
											Heads up — UI powered by DaisyUI.
										</span>
									</div>
								</div>
							</div>

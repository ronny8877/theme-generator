					...
					<div className="p-4 bg-base-200 border-b border-base-300">
						...
						{applyToTheme && originalThemeColors && (
							<div className="text-xs text-info bg-info/10 p-2 rounded mb-2">
								ℹ️ Simulation applied to original theme colors
						...
						{activeSimulation && (
							<label className="flex items-center gap-2 text-xs">
								<input
									...
									onChange={(e) =>
										setApplyToTheme(e.target.checked)
									}
				...
				<div className="p-4">
						...
						<Button
							...
							onClick={() =>
								handleSimulationSelect(
									activeSimulation || 'deuteranomaly'
								)
							}
							className="flex-1 text-xs"
						>
					...
					{!activeSimulation && (
						<div className="text-xs text-base-content/60 bg-base-200 p-3 rounded-lg">
							Select a simulation to see how people with visual
							impairments would perceive this template&apos;s
							colors.
						</div>
					)}
				</div>

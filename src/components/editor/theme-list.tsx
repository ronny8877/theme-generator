			...
			<AlertDialog open={confirmOpen} onOpenChange={setConfirmOpen}>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							You have unsaved edits. Save your current theme or
							discard changes before applying the new theme?
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
						<AlertDialogCancel
						...
						<AlertDialogAction
							onClick={() => onConfirmAction('discard-apply')}
						>
							Discard & Apply
						</AlertDialogAction>
						<AlertDialogAction
							onClick={() => onConfirmAction('save-apply')}
						>
							Save & Apply
						</AlertDialogAction>
					</AlertDialogFooter>
								...
								<AlertDialogContent>
									<AlertDialogHeader>
										...
										<AlertDialogDescription>
											...
											will permanently remove your saved
											theme &quot;{theme.name}&quot; from
											this device.
										</AlertDialogDescription>
									</AlertDialogHeader>
									<AlertDialogFooter>
					...
					>
						<div className="flex flex-row justify-center items-center gap-3">
							...
							{(() => {
								...
								const themeInfo =
									THEME_INFO[themeKey as ThemeInfoKey]

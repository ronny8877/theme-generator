						...
						<div className="grid grid-cols-2 gap-3">
							...
							<div className="form-control">
								...
								<input
									...
									onChange={(e) =>
										setS(Number(e.target.value) / 100)
									}
									className="range range-primary"
								/>
							...
							<div className="form-control">
								...
								<input
									...
									onChange={(e) =>
										setL(Number(e.target.value) / 100)
									}
									className="range range-primary"
								/>
								<div className="text-xs mt-1">

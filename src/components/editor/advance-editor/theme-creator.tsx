...
import { MultiColorPaletteGenerator } from './multi-color-palette-generator'
...
function useActiveColors() {
	...
	return {
		...
		['--color-secondary-content']:
			c['--color-secondary-content'] ?? '#0b1220',
		...
		<div className="space-y-6">
			...
			<div>
				...
				<input
					...
					onChange={(e) =>
						updateMiscConfig({
							'--border': `${Number(e.target.value)}px`,
						})
					}
			...
			<div>
				...
				<input
					...
					step={0.25}
					value={parseFloat(
						String(misc.sizeSelector).replace('rem', '')
					)}
					onChange={(e) =>
						updateMiscConfig({
			...
			<div>
				...
				<input
					...
					step={0.25}
					value={parseFloat(
						String(misc.sizeField).replace('rem', '')
					)}
					onChange={(e) =>
						updateMiscConfig({
							'--size-field': `${Number(e.target.value)}rem`,
						})
					}
					className="range range-primary mt-3 w-full"
				/>
		...
		<div className="grid grid-cols-1 gap-6">
			<div>
				...
				<input
					...
					onChange={(e) =>
						updateRadius({
							'--radius-box': `${Number(e.target.value)}rem`,
						})
					}
					className="range range-primary mt-3 w-full"
				/>
			...
			<div>
				...
				<input
					...
					onChange={(e) =>
						updateRadius({
							'--radius-field': `${Number(e.target.value)}rem`,
						})
					}
					className="range range-primary mt-3 w-full"
				/>

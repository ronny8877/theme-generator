		...
		<div className="bg-base-100 rounded-2xl p-5 border border-base-300 shadow-sm">
			...
			<div className="space-y-4">
				...
				<div className="bg-base-200 rounded-xl p-4 border border-base-300">
					...
					>
						This is sample body text that demonstrates how your
						chosen font settings will look in actual content. It
						includes multiple sentences to show the line height and

		...
		<section className="pt-16 lg:pt-24">
			<div className="text-center max-w-3xl mx-auto">
				...
				<p className="mt-4 text-lg lg:text-xl text-base-content/70">
					Create a custom DaisyUI theme and preview it on real
					templates—on phone, tablet, and desktop. Fine-tune colors,
					gradients, and typography, then see your changes live with
					zero setup.
				</p>

...
export default function WorkflowSteps() {
  const steps = [
    {
      ...
      desc: "Start with a professionally designed template—ready for blogs, portfolios, landing pages and more.",
    ...
    {
      title: "Share & Export",
      desc: "Share a link or export clean code. Works with any framework—copy CSS variables or theme JSON.",
      bullets: [
        "CSS variables based",
        "Framework agnostic",
        "Shareable themes",
  ...
  return (
    <section className="py-12 lg:py-16">
      <h2 className="text-center text-3xl lg:text-5xl font-extrabold mb-8">
        Three simple steps
      </h2>

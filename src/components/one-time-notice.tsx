	...
	return (
		...
		>
			<DialogContent aria-describedby="one-time-notice-desc">
				<DialogHeader>
					<DialogTitle>
						UwU Heads up — we&#39;re still polishing
					</DialogTitle>
					<DialogDescription id="one-time-notice-desc">
						Hi! We&#39;re still building and polishing the site, so
						you might experience a few bugs or see some bigger
						updates soon.
					</DialogDescription>
				</DialogHeader>
				...
				<div className="prose prose-sm max-w-none text-base-content/80">
					...
					<p className="mt-2">
						This message only shows on your first visit.
					</p>
				</div>

				...
				<div className="p-4 bg-base-200 rounded-lg border">
					...
					<div className="flex items-center justify-between text-sm">
						<div className="flex items-center gap-1">
							...
							<span>
								Affects: {currentSimulationInfo.prevalence}
							</span>
						</div>
					...
					<div className="flex items-start gap-3">
						...
						<div className="text-sm">
							...
							<p className="text-base-content/70">
								Select a simulation type above to see how your
								colors appear to people with different visual
								impairments. This helps ensure your designs are

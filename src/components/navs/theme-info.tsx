		...
		<div className="absolute left-1/2   -translate-x-1/2 z-50">
			<AlertDialog open={open} onOpenChange={setOpen}>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							Save your edited theme or discard changes before
							applying the template&apos;s theme?
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
			...
			<div className="group relative">
				...
				>
					...
					<div className="hidden md:block text-xs text-base-content/40">
						•
					</div>
					...
					<div className="border-t border-base-300 pt-2">
						...
						<div className="text-sm text-base-content space-y-2">
							<div className="truncate font-semibold">
								Heading: {heading.family} • {heading.weight} •{' '}
								{heading.size}
							</div>
							<div className="truncate text-xs text-base-content/70">
								Body: {body.family} • {body.weight} •{' '}
								{body.size}
							</div>

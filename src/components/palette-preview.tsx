...
function WebsiteMockup({
  ...
  return (
    ...
    >
      ...
      <div className="mb-6">
        <div
          className="w-32 h-3 rounded mb-2"
          style={{ backgroundColor: text, opacity: 0.8 }}
        />
        <div
          className="w-48 h-2 rounded mb-4"
    ...
    >
      ...
      >
        ...
        <div className="mb-4">
          ...
          />
          <div
            className="w-32 h-2 rounded mb-1"
            style={{ backgroundColor: text, opacity: 0.5 }}
          />
          <div
          ...
          <div className="space-y-2">
            {[1, 2, 3, 4].map((i) => (
              <div
                ...
                style={{
                  backgroundColor: i === 1 ? primary : secondary,
                  opacity: i === 1 ? 1 : 0.3,
                }}
              />
            ))}
        ...
        <div className="space-y-3">
          {[1, 2, 3].map((i) => (
            ...
            >
              ...
              <div className="flex-1">
                <div
                  className="w-16 h-1 rounded mb-1"
                  style={{ backgroundColor: text, opacity: 0.6 }}
                />
                <div
        ...
        >
          {[1, 2, 3, 4].map((i) => (
            <div
              ...
              style={{
                backgroundColor: i === 2 ? primary : text,
                opacity: i === 2 ? 1 : 0.3,
              }}
            />
          ))}

		...
		<div className="space-y-4">
								...
								<div className="flex items-center gap-2">
									...
									{textContrast && (
										<div className="flex items-center gap-1">
											<Badge
												variant={
													textContrast.isAccessible
														? 'default'
														: 'destructive'
												}
												className="text-xs px-1 py-0 h-5"
											>
												Text: {textContrast.ratio} (
												{textContrast.level})
											</Badge>
										</div>
									)}
			...
			<div className="mt-6 p-3 bg-base-200 rounded-lg border">
				...
				<div className="text-xs text-base-content/70 space-y-1">
					<div>
						<span className="font-semibold">AAA:</span> 7:1+ ratio -
						Best accessibility
					</div>
					<div>
						<span className="font-semibold">AA:</span> 4.5:1+ ratio
						- Good accessibility
					</div>
					<div>
						<span className="font-semibold">A:</span> 3:1+ ratio -
						Minimum for large text
					</div>
					<div>
						<span className="font-semibold">FAIL:</span> Below 3:1 -
						Poor accessibility
					</div>
				</div>
			</div>

...
import { DAISY_UI_AVILABLE_THEMES, THEME_INFO } from '@/lib/constants/constants'
		...
		<div className="h-full flex flex-col gap-6">
			<div>
				...
				<p className="text-sm text-base-content/70 mb-4">
					Choose the visual theme for the application interface. This
					affects the overall look and feel of the app.
				</p>
				...
				<div className="grid grid-cols-2 sm:grid-cols-3 gap-3 max-h-64 overflow-y-auto theme-scroll pr-2">
					{DAISY_UI_AVILABLE_THEMES.map((theme) => {
						const themeInfo =
							THEME_INFO[theme as keyof typeof THEME_INFO]
			...
			<div className="border-t border-base-300 pt-6">
				...
				<div className="text-sm text-base-content/70 space-y-2">
					<p>
						App themes control the visual appearance of the
						interface elements like buttons, navigation, and panels.
						This is separate from the color themes you create for
						your designs.
					</p>
					<p>
						Your selected app theme will be saved and applied

...
export function AboutTool() {
	...
	const handleGithubOpen = () => {
		window.open(
			'https://github.com/your-username/theme-generator',
			'_blank'
		)
	}
			...
			<div className="space-y-8 p-1">
				...
				<div className="space-y-4">
					...
					<div className="p-4 rounded-lg bg-muted/50 border">
						<p className="text-sm leading-relaxed">
							We believe that great design starts with great
							colors. Our mission is to provide professional-grade
							color tools that are both powerful and accessible,
							helping designers and developers create beautiful,
				...
				<div className="space-y-4">
					...
					<div className="space-y-3 text-sm text-muted-foreground">
						<p>
							As designers and developers, we found ourselves
							constantly switching between different tools for
							color work - one for conversion, another for
							palettes, and yet another for gradients.
						</p>
						<p>
							We wanted a single, powerful platform that could
							handle all color-related tasks while maintaining
							professional-grade accuracy and providing real-time
							accessibility feedback.
						</p>
						<p>
							The result is this comprehensive color toolkit that
							we use daily in our own design and development work.
						</p>
					</div>
				</div>
				...
				<div className="space-y-4">
					...
					<div className="space-y-3">
						<p className="text-sm text-muted-foreground">
							Have feedback, suggestions, or want to request a new
						...
						<div className="flex items-start gap-3">
							...
							<div>
								...
								<p className="text-sm text-muted-foreground mt-1">
									Star us on GitHub, share with your design
									team, or contribute to the project. Your
									support helps us keep improving and adding
									new features.
								</p>
								<Button
									size="sm"

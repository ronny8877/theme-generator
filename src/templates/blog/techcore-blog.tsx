					...
					<div className="relative z-10 flex flex-col items-center gap-6">
						<div className="flex flex-col gap-4 text-primary">
							...
							<h2 className="mx-auto max-w-2xl text-sm @sm:text-base font-normal leading-normal text-primary-content">
								Explore the latest innovations and insights in
								the world of technology. From groundbreaking
								gadgets to in-depth reviews, stay ahead of the
								curve with our expert analysis and commentary.
							</h2>
						</div>
								...
								>
									...
									<div className="flex-1">
										...
										<p className="text-sm font-normal leading-normal text-base-content">
											A short excerpt highlighting the
											post&apos;s topic and why it&apos;s
											worth reading.
										</p>
										<a

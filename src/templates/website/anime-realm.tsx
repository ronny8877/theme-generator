			...
			<div className="max-w-7xl mx-auto px-4 @sm:px-6 @lg:px-8 grid @md:grid-cols-2 gap-8 @md:gap-12 items-center">
				...
				<div className="space-y-4">
					...
					<p className="text-base md:text-lg text-secondary leading-relaxed">
						In a desolate future, humanity shelters in mobile
						fortress cities, constantly threatened by colossal
						creatures known as Klaxosaurs. To combat these threats,
						children are bred to pilot giant mechs called Franxx,
						fighting for survival in a world teetering on the edge.
						Their connections, both in and out of the cockpit, will
		...
		<footer className="bg-base-200 border-t border-primary/20 mt-16">
			<div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 text-center">
				<p className="text-secondary">
					© Darling in the Franxx Fan Project
				</p>
			</div>
		</footer>
	)

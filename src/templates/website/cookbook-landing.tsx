				...
				<div className="w-full max-w-6xl flex flex-col gap-8">
					<div className="text-center">
						...
						<p className="mt-4 text-lg text-base-content/70">
							Search through thousands of recipes from around the
							world.
						</p>
					</div>
							...
							{[
								{
									...
									image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBjwKT5lB611UrkPsRCA1idDZ1pcaPKW7WLDRNirXkqMw_78gbGYidIj3SKbaCZJz-dJWQwZyquoQQUanee8BXZ9FdvBO7tSL3HxpQ3YkoPRM3nnlYoo8SwcZ7Uy9LE-AfP8AMxqUZsmoWqUWJU25mJCreo7LAGNrJeVmoePt_A2XRC4nYc7JVnfT8FljIinToi5PLGpMrlay8xwpFKhgZnEeyD81CyaXlNekADAxtXastpNHjXZ-0lhWuKEOQhG-J97E_QVsrOpYg',
								},
								{
									title: 'Apple Crumble',
									image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuB6pILlyu4ZKJ2JpX_nIxfEeLUgxlUCzDCFsMPGLToT1MUJKvJfFpvYWJNxExax95qmc7PEWClSBmbrlh2lSrHU2a7LBHP63Rvix7bLRi5OuWozfcgyyOS4C642wxm08vLBYVT3IHctd1BNeWxkN_ETJaJA0KbPB4mZSERq3YpqeCTayr8PRuW6zX4abkyY-5RzvPwLWURCPN_wSF40Mu7yhPeNVFingz-uhndnx0b9lj1egMHgTQpkrCvb2iuTm4rzU_GQNmqS1ns',
								},
								{
									title: 'Roasted Turkey with Cranberry Sauce',
									image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAzDhDFT7X-_8cc6jPXfDwTlWpTBnHYYKPCTLowhIiFapXjTm0KvTrLTNJ16lLonOVYX4crvpEQDpcQ0_jXARwap_UOafvzj8nr78tR3ObvWk3wOOwVosQNItW531qRfxxfSdMNGs8CNwu_yNStjGh5qZ7X5Co1Nx4tFNC_9c0fnQu5m4GJURdMAQVQfNKiiuzitJjIvNjI1FyVy-pYDCbVehUdgkl_eMOlfiRyuuJObpCZSluLIRt_wlATdvvcVTP4yLhGVEWomHU',
								},
								{
									title: 'Gingerbread Cookies',
									image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDUdL9GJEOpMUnyftiJQerxS3uReNU99wJdm6cwBAXQEcg4oIy7Jnce3dlLqgoIqEtrrhQrAayvAgYiQaTKwuQKz8KkZ92x3n_8dVu6oAxbyEn5dFRjbzonnH4QhPBchK_CzLyC8fF0JSWkJqDdJgtm1rdzOug1Q7N4iqMnP34Xv3i8CB2iWd5HMddnh3TO96TvqLWyfg3_cJqjKYoW5cgRpBQUGvkALofaYbWOTf2X2OzYjPpQB8gV9qf_cmGF-bY37qNN3OvyDMY',
								},
							].map((r) => (
								<div
									key={r.title}

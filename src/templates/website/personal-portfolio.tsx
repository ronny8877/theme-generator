							...
							<div className="space-y-6">
								<div className="space-y-4">
									...
									<p className="text-base @md:text-lg @lg:text-xl text-base-content/70 max-w-2xl leading-relaxed">
										I create beautiful, responsive web
										applications that provide exceptional
										user experiences. Passionate about clean
										code and innovative solutions that make
										a difference.
									</p>
								</div>
				...
				<div className="container mx-auto px-4">
					<div className="text-center mb-12">
						...
						<p className="text-sm @md:text-base @lg:text-lg text-base-content/70 max-w-3xl mx-auto">
							Im a passionate full-stack developer with over 3
						...
						<div className="space-y-6">
							<div className="space-y-4">
								...
								<p className="text-sm @md:text-base text-base-content/80 leading-relaxed">
									Started my journey in web development with a
									curiosity for how things work on the
									internet. Over the years, Ive honed my
									skills in both frontend and backend
									technologies, always staying up-to-date with
									the latest industry trends.
								</p>
								<p className="text-sm @md:text-base text-base-content/80 leading-relaxed">
									When Im not coding, you can find me
									exploring new technologies, contributing to
									open-source projects, or sharing knowledge
			...
			<section className="py-12 @lg:py-20 bg-base-200">
				<div className="container mx-auto px-4">
					<div className="text-center mb-12">
						...
						<p className="text-sm @md:text-base @lg:text-lg text-base-content/70 max-w-3xl mx-auto">
							Feedback from colleagues and clients Ive had the
			...
			<section id="contact" className="py-12 @lg:py-20">
				<div className="container mx-auto px-4">
					<div className="text-center mb-12">
						...
						<p className="text-sm @md:text-base @lg:text-lg text-base-content/70 max-w-3xl mx-auto">
							Have a project in mind or want to collaborate? Id
					...
					<div className="grid @lg:grid-cols-2 gap-8 @lg:gap-12">
						<div className="space-y-6">
							...
							<p className="text-sm @md:text-base text-base-content/80 leading-relaxed">
								IIm always interested in hearing about new
